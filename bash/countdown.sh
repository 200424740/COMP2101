...
#Assigning myFunction1 to SIGINT
trap myFunction1 SIGINT
#Assigning myFunction2 to SIGQUIT
trap myFunction2 SIGQUIT
...
function myFunction2 {
  echo "You found out the secret to get out of the script"
      exit
}
